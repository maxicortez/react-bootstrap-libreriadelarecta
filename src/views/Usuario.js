    ...
    const eliminarUsuario = async (id) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                const response = fetch("api/usuario/Eliminar/" + id, { method: "DELETE" }).then((response) => {
                    if (response.ok) {
                        obtenerUsuarios();
        ...
        <>
            <Card>
                ...
                <CardBody>
                    ...
                    <hr></hr>
                    <DataTable columns={columns} data={usuarios} progressPending={pendiente} pagination paginationComponentOptions={paginationComponentOptions} customStyles={customStyles} />
                </CardBody>
            </Card>
