    ...
    const eliminarProducto = async (id) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                const response = fetch("api/producto/Eliminar/" + id, { method: "DELETE" }).then((response) => {
                    if (response.ok) {
                        obtenerProductos();
        ...
        <>
            <Card>
                ...
                <CardBody>
                    ...
                    <hr></hr>
                    <DataTable columns={columns} data={productos} progressPending={pendiente} pagination paginationComponentOptions={paginationComponentOptions} customStyles={customStyles} />
                </CardBody>
            </Card>
